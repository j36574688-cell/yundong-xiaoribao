// AUDITED BUILD: all 29 sports, 95 configured leagues, and 28 selectable content types are preserved.
// Retrieval uses site-scoped search first, then a broad-search fallback, with local time filtering.
// Esports sources are merged with country-local sources so fixes for one sport do not remove another.
...
const LEAGUE = {
  ...
  'League of Legends':['League of Legends','LoL','英雄联盟'], LCK:['LCK','League of Legends Champions Korea'], LPL:['LPL','League of Legends Pro League','英雄联盟职业联赛','英雄联盟LPL'], LEC:['LEC','League of Legends EMEA Championship'], LCS:['LCS','League of Legends Championship Series'], Valorant:['Valorant','VALORANT','無畏契約'], VCT:['Valorant Champions Tour','VCT','VCT CN','无畏契约冠军巡回赛'], CS2:['Counter-Strike 2','CS2','反恐精英2','CSGO'], BLAST:['BLAST Premier','BLAST'], ESL:['ESL','ESL Pro League'], 'Dota 2':['Dota 2','Dota2','刀塔2','DOTA2'],
...
const ESPORTS_SITES = {
  "League of Legends":["lolesports.com","wanplus.cn","news.17173.com","invenglobal.com","sheepesports.com","dotesports.com","esportsinsider.com","dexerto.com","dailyesports.com"],
  LCK:["lolesports.com","invenglobal.com","dailyesports.com","fomos.kr","inven.co.kr","sheepesports.com","dexerto.com"],
  LPL:["lolesports.com","wanplus.cn","news.17173.com","esports.sina.com.cn","invenglobal.com","dotesports.com","esportsinsider.com","dexerto.com","sheepesports.com"],
  ...
  Valorant:["valorantesports.com","vlr.gg","thespike.gg","news.17173.com","wanplus.cn","esports.gg","dotesports.com","esportsinsider.com","sheepesports.com","dexerto.com"],
  VCT:["valorantesports.com","vlr.gg","thespike.gg","news.17173.com","wanplus.cn","esports.gg","dotesports.com","esportsinsider.com","sheepesports.com","dexerto.com"],
  CS2:["hltv.org","news.17173.com","wanplus.cn","dust2.us","blast.tv","esl.com","esports.gg","dotesports.com","esportsinsider.com","escorenews.com"],
  BLAST:["blast.tv","hltv.org","news.17173.com","wanplus.cn","dust2.us","esl.com","esports.gg","dotesports.com","escorenews.com"],
  ESL:["esl.com","hltv.org","news.17173.com","wanplus.cn","dust2.us","esports.gg","dotesports.com","esportsinsider.com","escorenews.com"],
  "Dota 2":["dota2.com","gosugamers.net","news.17173.com","wanplus.cn","escorenews.com","dotesports.com","esportsinsider.com","esports.gg","liquipedia.net"]
};
...
function leagueAccept(title,section,url='',sourceUrl=''){
  ...
  // A known league/site source is enough even when the headline omits the league name.
  ...
  if(selectedHit || sourceIsKnown) return true;

  // Hard filter across every configured sport, not just the previously hard-coded sports.
  ...
  for(const [code,items] of rs){
    for(const raw of items){
      ...
      if(!old) map.set(k,a); else {
        ...
        if(Date.parse(a.publishedAt)>Date.parse(old.publishedAt)) Object.assign(old,{title:a.title,url:a.url,sourceName:a.sourceName,publishedAt:a.publishedAt,language:a.language,sourceUrl:a.sourceUrl});
      }
    }
  }
